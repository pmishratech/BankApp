...
import org.bankapp.model.Accounts;
...
public class BankAccountController {
	...
	public int getAccountBalance(@PathVariable int acctID) {
	...
	public void depositAmount(@PathVariable int acctID, @PathVariable int amount) {
		int initBal = getAccountBalance(acctID);
	...
	public void transferAmount(@PathVariable int acctID, @PathVariable int destAcctID, @PathVariable int amount) {
		int initBalSender = getAccountBalance(acctID);
		int initBalReceiver = getAccountBalance(destAcctID);
	...
	public Accounts getAccountDetails(@PathVariable int acctID) {
